...
import com.ives.cn.R;
import com.ives.cn.util.StatusKit;
 ...
 */
 class HostLayout extends RelativeLayout implements Bar {
    ...
    HostLayout(Activity activity) {
        ...
        StatusKit.invasionStatusBar(mActivity);
        StatusKit.invasionNavigationBar(mActivity);
        StatusKit.setStatusBarColor(mActivity, Color.TRANSPARENT);
        StatusKit.setNavigationBarColor(mActivity, Color.TRANSPARENT);
    }
    @Override
    ...
    public Bar statusBarDarkFont() {
        StatusKit.setStatusBarDarkFont(mActivity, true);
        return this;
    }

    @Override
    public Bar statusBarLightFont() {
        StatusKit.setStatusBarDarkFont(mActivity, false);
        return this;
    }
